            ...
            >
              ...
              <div class="carousel-inner">
                ...
                <div class="item">
                  ...
                  >
                    <span class="Title1" style = "font-size: 18px; text-shadow: none;  line-height: 20px;  color:#e6739f"
                      >“It wasn’t a simple headache. It was blurring my sight, my happiness, my body, extending the pain to every cell, every muscle, every inch of my being. Many ideas come to my already congested mind, one of them was to end my life and forever be pain-free. I thought about taking some painkillers, but I wasn’t able to do it. I suppose my willpower and my primary need to stay sober were stronger than the painkillers. I knew that if I took a single pill, it could have gotten from 1 every 6 hours to 4 pills per hour, as I used to do.” <a style = "color : #e6739f;" href="experience.html">..Read More</a></span
                    >
                    <footer>
                      <cite>Mederos</cite>
                    </footer>
