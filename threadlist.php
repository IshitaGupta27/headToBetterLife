...
<?php
    ...
    if($method=='POST'){
		...
		if($numOfBadWords>0)
		{
			echo"<script language='javascript'>
				alert('Bad Posting Not Allowed!!! Please watch you Post!!!');
			</script>
			";
		}
		else
    ...
    <div class="jumbotron">
            ...
            Do not post “offensive” posts, links or images.
             Do not cross post questions. Remain respectful of other 
...
<form action="<?php echo $_SERVER['REQUEST_URI']?>" method="post">
  <div class="form-group">
    ...
    <small id="emailHelp" class="form-text text-muted">Keep your title as short and crisp as possile </small>
  </div>
  <div class="form-group">
